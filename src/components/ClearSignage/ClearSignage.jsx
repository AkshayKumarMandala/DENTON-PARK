...
const signageData = [
  {
    ...
    description:
      "Guides visitors to key locations within the park, helping them navigate attractions and amenities.",
  },
  {
    id: 2,
    ...
    description:
      "Indicates the location of fire extinguishers for emergency situations, ensuring safety.",
  },
  {
    id: 3,
    ...
    description:
      "Designates areas where guests can seek assistance or refuge in case of emergencies.",
  },
  {
    id: 4,
    ...
    description:
      "Directs guests to restroom facilities, clearly marked for convenience.",
  },
  {
    id: 5,
    ...
    description:
      "Guides visitors to parking areas and indicates the location of designated parking spots.",
  },
  {
    id: 6,
    ...
    name: "Food Signage",
    description:
      "Displays information about food options available in the park, including menus and specials.",
  },
  {
    id: 7,
    ...
    description:
      "Indicates the location of emergency exits for safe evacuation in case of an emergency.",
  },
  {
    id: 8,
    ...
    description:
      "The baby feeding signage provides clear directions to designated feeding areas, promoting a welcoming environment for nursing and bottle-feeding.",
  },
];
