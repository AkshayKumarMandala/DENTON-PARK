...
const AdminPhotographers = () => {
  ...
  const markUnavailable = async (photographerId, date, time) => {
    ...
    // Update the bookings in state after adding a new one
    setBookings((prevBookings) => ({
      ...prevBookings,
      [photographerId]: [
        ...(prevBookings[photographerId] || []),
        { date, time },
      ],
    }));
