    ...
    <>
      <div className="flex flex-col items-center p-5  ">
        ...
        <div className="title flex flex-col justify-center items-center h-[20vh]  bg-black w-full">
          <h1 className="text-4xl font-bold text-white transition-transform transform hover:scale-105">
            Welcome to DENTON Park!
          </h1>
          <p className="text-3xl text-yellow-600 italic">
        ...
        <div className="family flex flex-wrap justify-center mb-10 bg-slate-800">
          <div className="description w-full md:w-1/2 p-4 flex items-center justify-center">
            <p className="text-white">
              ...
              family has everything they need to enjoy a fun-filled day.
            </p>
          </div>
        ...
        <div className="children flex flex-wrap justify-center mb-10 bg-slate-800">
          ...
          <div className="description w-full md:w-1/2 p-4 flex items-center justify-center">
            <p className="text-white">
              ...
              cakes, or indulge in gourmet meals prepared by our top chefs.
            </p>
          </div>
        </div>
        ...
        <div className="motto flex flex-wrap justify-center mb-10 p-5 bg-gradient-to-r from-yellow-800 to-yellow-800 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          ...
          <section className="values-section w-full md:w-1/2 p-4 flex flex-col justify-center items-start">
            ...
            <ul className="list-disc list-inside text-gray-800">
              {["Adventure", "Family", "Safety", "Fun", "Community"].map(
                (value) => (
                  <li
                    key={value}
        ...
        <div className="team mb-10">
          ...
          <div className="team-members flex flex-wrap justify-center">
            {[
              ...
              <div
                className="team-member w-full md:w-1/3 p-4 text-center transition-transform transform hover:scale-105"
                key={member.name}
              >
                <div className="bg-white rounded-lg shadow-lg p-5 transition-shadow hover:shadow-2xl">
                  <img
                    src={member.img}
                    alt={member.name}
                    className="rounded-full mb-2 w-32 h-32 mx-auto"
                  />
        ...
        <div className="footer">
          <footer className="about-us-footer text-center mt-10">
            <p className="text-gray-600">
              Join us for a day full of adventure, laughter, and happiness!
            </p>
          </footer>
        </div>
      </div>
