  ...
  const restaurantsdata = [
    {
      ...
      estimated: "30$ for 2",
      description:
        "A Mediterranean oasis offering a fresh, organic menu inspired by the Mediterranean coast.",
    },
    {
      id: 2,
      ...
      estimated: "40$ for 2",
      description:
        "Experience authentic Indian flavors with spices that bring traditional dishes to life.",
    },
    {
      id: 3,
      ...
      estimated: "50$ for 2",
      description:
        "Asian fusion cuisine combining traditional Thai, Vietnamese, and Korean flavors.",
    },
  ];
            ...
            >
              ...
              <div className="p-6 flex-1">
                ...
                <p className="text-gray-600 font-semibold mt-2">
                  Estimated: {restaurant.estimated}
                </p>
              </div>
